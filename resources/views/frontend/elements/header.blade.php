            ...
            <div class="d-inline-flex align-items-center">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        {{-- <a href="{{route('front.logout')}}" class="dropdown-item" type="button">Logout</a> --}}
                        @else
                        <a href="{{route('front.login')}}" class="dropdown-item" type="button">Sign in</a>
                        <a href="{{route('front.register')}}" class="dropdown-item" type="button">Sign up</a>
        ...
        <div class="col-lg-3 d-none d-lg-block">
            ...
            <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('front.product',['category'=>$cat->id])}}" class="nav-item nav-link">{{$cat->name}}</a>
                    @endforeach
                </div>
            </nav>
        </div>
            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <a href="{{route('front.product')}}" class="nav-item nav-link">Products</a>
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                <a href="/pages/about" class="dropdown-item active">About</a>
                                <a href="/pages/contact" class="dropdown-item">Contact</a>
                                <a href="/pages/help" class="dropdown-item">Help</a>
                                <a href="/pages/faqs" class="dropdown-item">FAQs</a>
                                <a href="/pages/terms" class="dropdown-item">Terms</a>
                                <a href="/pages/privacy" class="dropdown-item">Privacy</a>
                    ...
                    <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                        {{-- <a href="" class="btn px-0">
                            ...
                            <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;">1000</span>
                        </a> --}}
