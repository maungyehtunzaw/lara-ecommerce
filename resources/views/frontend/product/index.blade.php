        ...
        <form action="{{ route('front.product') }}" method="GET">
            <div class="row px-xl-5 my-2">
                ...
                <div class="d-flex col-md-3">
                    ...
                    <a href="{{ route('front.product') }}" class="btn btn-danger">Clear</a>
                </div>
            </div>
        </form>
                    ...
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                <button class="btn btn-outline-dark btn-square" id="addToCart"
                                    data-id="{{ $p->id }}"><i class="fa fa-shopping-cart"></i></button>

                                <a class="btn btn-outline-dark btn-square"
                                    href="{{ route('front.product.show', $p->id) }}"><i class="fa fa-info-circle"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate"
                                href="{{ route('front.product.show', $p->id) }}">{{ $p->name }}</a>
